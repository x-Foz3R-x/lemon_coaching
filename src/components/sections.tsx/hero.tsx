...
import PixelMesh from "~/components/ui/pixel-mesh";
  ...
  return (
    <section className="relative w-full">
      ...
      <h1 className="font-pixel text-4xl leading-14 tracking-tighter text-shadow-[0_0_2px_#000,_0_0_4px_#fff] sm:text-5xl md:text-6xl">
        Level Up Your
        <div className="text-neon-green text-xl leading-9 sm:text-2xl md:text-3xl">
          League of Legends
        </div>
      ...
      <Button variant="pixel" className="mt-8 uppercase">
        Book a Session
      </Button>
    </section>
  );
